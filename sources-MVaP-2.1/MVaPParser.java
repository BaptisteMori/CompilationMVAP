...
public class MVaPParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "WS", "ENTIER", "FLOAT", "'ADD'", "'SUB'", "'MUL'", "'DIV'", 
		"'INF'", "'INFEQ'", "'SUP'", "'SUPEQ'", "'EQUAL'", "'NEQ'", "'FADD'", 
		"'FSUB'", "'FMUL'", "'FDIV'", "'FINF'", "'FINFEQ'", "'FSUP'", "'FSUPEQ'", 
		"'FEQUAL'", "'FNEQ'", "'ITOF'", "'FTOI'", "'RETURN'", "'POP'", "'POPF'", 
		"'READ'", "'READF'", "'WRITE'", "'WRITEF'", "'PADD'", "'PUSHGP'", "'PUSHFP'", 
		"'DUP'", "'PUSHI'", "'PUSHG'", "'STOREG'", "'PUSHL'", "'STOREL'", "'PUSHR'", 
	...
	public final Instr1Context instr1() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(45); ((Instr1Context)_localctx).c = commande1();
			 instrAddress++; 
			}
		}
		catch (RecognitionException re) {
	...
	public final Instr2Context instr2() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(50); commande2();
			setState(51); match(ENTIER);
	...
	public final Instr2fContext instr2f() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(54); match(PUSHF);
			setState(55); match(FLOAT);
	...
	public final SautContext saut() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(60); commandeSaut();
			setState(61); match(ENTIER);
			 instrAddress+=2; /* 2 entiers pour stocker l'instruction */ 
			}
		}
		catch (RecognitionException re) {
	...
	public final LabelContext label() throws RecognitionException {
		...
		try {
			...
			setState(65); ((LabelContext)_localctx).ENTIER = match(ENTIER);
	...
	public static final String _serializedATN =
		...
		"\2\2\f\2\4\6\b\n\f\16\20\22\24\2\5\4\2\6&\65\65\3\2\'/\3\2\61\64B\2\27"+
		...
		"\5\2\34\35\7\67\2\2\35,\3\2\2\2\36\37\5\f\7\2\37 \7\67\2\2 ,\3\2\2\2!"+
